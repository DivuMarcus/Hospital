package strattons.com.hospital.Adapters
...
class UserRecyclerAdapter(private val listUsers:List<User>):RecyclerView.Adapter<UserRecyclerAdapter.UserViewHolder>() {
